"""Portable direct training for SliceEqOcc-OAAC-Strong with H7.19 MPD.
...
EXPECTED_STRONG_TRAIN_SHA256 = (
    '01c681e54a3e9616fa6fb90d594d28e73db1b98a1f86ed5540c482844ab4fee5')
...
import train_sliceeq_occ_oaac_strong_portable as strong  # noqa: E402
...
def _validate_args(flags):
    ...
    # Dataset storage is machine-specific. Scientific identity is enforced by
    # validate_promise12_root(strict_split=True, check_hdf5=True) below.
    locked_recipe = {
